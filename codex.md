...
All context lives in `CLAUDE.md` — read that file; it applies to Codex
verbatim (commands, the rules, what the app is, what is open). Design
reference: `ARCHITECTURE.md` is the index of `docs/*.md`.
